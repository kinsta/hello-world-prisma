    ...
    <div>
      ...
      <div className="pt-[10vh] px-2 mx-auto max-w-[880px] lg:min-h-screen">
        ...
        <article className="mt-4 rounded rounded-[40px] p-[2px] bg-gradient-to-b from-kinsta-shadow to-kinsta-shadow/0">
          <div className="inner rounded rounded-[40px] bg-kinsta-dark-blue lg:px-[40px] lg:py-[64px] px-[16px] py-[40px]">
            <div className="text-center text-white">
              <h2 className="text-[24px] lg:text-[32px] font-bold mb-3">Try Prisma DB connection:</h2>
            </div>
        ...
        <article className="mt-4 rounded rounded-[40px] p-[2px] bg-gradient-to-b from-kinsta-shadow to-kinsta-shadow/0">
          <div className="inner rounded rounded-[40px] bg-kinsta-dark-blue lg:px-[40px] lg:py-[64px] px-[16px] py-[40px]">
            <div className="text-center text-white">
              <h2 className="text-[24px] lg:text-[32px] font-bold mb-3">Welcome to Your New <strong>Prisma</strong>&nbsp;Site</h2>
            ...
            <div className="grid gap-[5px] lg:grid-cols-2 grid-cols-1 mt-10">
              <a href="https://www.prisma.io/" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" rel="nofollow">
                <h3 className="text-white font-bold mb-4 text-[20px]">Official Prisma Website</h3>
                <p className="text-white/50 text-[16px]">Learn more about Prisma’s capabilities through its official site.</p>
              ...
              <a href="https://www.prisma.io/docs" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" rel="nofollow">
                <h3 className="text-white font-bold mb-4 text-[20px]">Prisma Documentation</h3>
                <p className="text-white/50 text-[16px]">Visit Prisma’s documentation to learn how to edit this page.</p>
              ...
              <a href="https://github.com/kinsta/hello-world-prisma" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" rel="nofollow">
                <h3 className="text-white font-bold mb-4 text-[20px]">Download Starter</h3>
                <p className="text-white/50 text-[16px]">Get started with Prisma in a matter of minutes.</p>
              ...
              <a href="https://github.com/kinsta" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" rel="nofollow">
              ...
              <a href="https://kinsta.com/discord" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" rel="nofollow">
              ...
              <a href="https://twitter.com/kinsta" target="_blank" className="kinsta-starter-link block rounded rounded-[4px] border pt-[24px] pb-[24px] pl-[24px] pr-[54px] border-kinsta-shadow relative transition-all delay-150 hover:bg-kinsta-shadow/60" rel="nofollow">
        ...
        <div className="text-white text-center pb-10 mt-5 text-[16px] text-white/70">
          <p>Host your new site on Kinsta. <a href="https://kinsta.com/application-hosting/" className="text-[#A99FFB] hover:text-white transition-all delay-100" rel="nofollow">Start your free trial</a>.</p></div>
      </div>
